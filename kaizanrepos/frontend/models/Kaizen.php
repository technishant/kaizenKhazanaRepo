...
//            }"],
    ...
    public function attributeLabels() {
        return [
            ...
            'processarea' => Yii::t('app', 'Processarea'),
            'category' => Yii::t('app', 'Category'),
            'company' => Yii::t('app', 'Company'),
            'currrentstage' => Yii::t('app', 'Currrentstage'),
            'mode' => Yii::t('app', 'Mode'),
            'tangiblebenifits' => Yii::t('app', 'Tangiblebenifits'),
            'intengiblebenifits' => Yii::t('app', 'Intengiblebenifits'),
            'costsaving' => Yii::t('app', 'Costsaving'),
            'implementationdate' => Yii::t('app', 'Implementationdate'),
            'postedby' => Yii::t('app', 'Postedby'),
            'posteddate' => Yii::t('app', 'Posteddate'),
            'suggestedby' => Yii::t('app', 'Suggestedby'),
            'approvedby' => Yii::t('app', 'Approvedby'),
            'recordstatus' => Yii::t('app', 'Recordstatus'),
        ];
    }
