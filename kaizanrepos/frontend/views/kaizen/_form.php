    ...
    <div class="container">
        <div class="row">
						...
						$form = ActiveForm::begin(['id' => 'form-signup', 'options' => [
									'class' => 'register clearfix', 'enctype' => 'multipart/form-data']]);
						?>
            ...
            <div class="col-sm-12 clearfix">
                <div class="form-group">
										<?=
										$form->field($model, 'type')->dropDownList([0 => 'Kaizen',
											1 => 'Image', 2 => 'Video', 3 => 'E-Book'], ['id' => 'kaizen-type-dropdown']);
										?>
                </div>
                <div class="form-group">
										<?php
										...
										echo $form->field($model, 'category')->dropDownList(
											$listData, ['onchange' => 'getSubCat(this.value,"' . Yii::$app->homeUrl . '")',
											'prompt' => 'Select']
										);
										?>
                </div>
                ...
                <div class="form-group hideFields">
										<?=
										$form->field($model, 'attachmenttype')->radioList(array(
											'video' => 'Video', 'image' => 'Image', 'pdf' => 'Pdf', 'ppt' => 'Ppt'));
										?>
                </div>
            </div>
            ...
            <div class="col-sm-6 clearfix">
                ...
                <div class="form-group hideFields">
										<?=
										$form->field($model, 'processarea')->textInput([
											'rows' => 6])
										?>
                </div>
                ...
                <div class="form-group hideFields">
										<?=
										$form->field($model, 'intengiblebenifits')->textarea([
											'rows' => 6])
										?>
                </div>
            </div>
            ...
            <div class="col-sm-12 clearfix">
                <div class="form-group" align="center">
										...
										Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), [
											'class' => $model->isNewRecord ? 'btn btn-primary btn-lg submitBtn' : 'btn btn-primary btn-lg submitBtn'])
										?>
                    <a style="margin-left: 20px;" href="<?= Yii::$app->homeUrl; ?>"><?=
												Html::button(Yii::t('app', 'Cancel'), [
													'class' => 'btn btn-default btn-lg submitBtn'])
												?></a>
                </div>
            </div>
